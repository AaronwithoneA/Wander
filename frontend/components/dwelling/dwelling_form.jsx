...
class DwellingForm extends React.Component {
  ...
  render () {
    return (
      <div className="dwelling-form-page">
        <img
          src="http://res.cloudinary.com/dg8v2pvxf/image/upload/v1486492166/beautiful-wallpapers-High-Resolution-Download9_u961gg.jpg"
          className="dwelling -form-image"/>
